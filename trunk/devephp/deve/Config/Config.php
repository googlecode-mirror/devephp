...
return  array(
	...
	'DEFAULT_CONTROL'       => 'Action',  // 默认控制器名称
	'DEFAULT_ACTION'        => 'show', // 默认操作名称
	...
	'DATA_CACHE_PATH'       => TMP_PATH,// 缓存路径设置 (仅对File方式缓存有效)
	...
	'LOG_RECORD_LEVEL'      => array('EMERG','ALERT','CRIT','ERR','NOTIC','WARN'),// 允许记录的日志级别
