...
INSERT INTO `form` (`id`, `title`, `content`, `user_id`, `create_time`, `update_time`, `status`, `email`) VALUES
...
(3, 'test', 'ssssssssssss', 0, 1327301796, 0, 1, 'test@gq.com'),
(4, 'vvvvv', 'vvvvvvvvvvvvvvvv', 1, 1329234559, 0, 1, '');
...
(2, 'Server', 'VPS管理', 1222841259, 0, 1, 0, 0),
(3, 'File', '文件管理', 1222841259, 0, 1, 0, 0),
(4, 'Tool', '应用中心', 1222841259, 0, 1, 0, 0),
(5, 'Note', '记事本&nbsp;', 1222841259, 0, 1, 0, 0);
...
(69, 'Webserver', 'WEB服务器', 1, '', 1, 1, 2, 0, 2),
(7, 'Dbserver', 'Db管理', 1, '', 4, 1, 2, 0, 2),
(6, 'Memserver', 'Memcached', 1, '', 3, 1, 2, 0, 2),
(2, 'Shell', 'Linux命令', 1, '', 2, 1, 2, 0, 2),
(1, 'Rbac', 'Rbac后台管理', 1, '', NULL, 0, 1, 0, 0),
(50, 'main', '空白首页', 1, '', NULL, 40, 3, 0, 0),
(83, 'Collect', '数据采集', 1, '', 1, 1, 2, 0, 4);
...
INSERT INTO `photo` (`id`, `image`, `create_time`) VALUES
(1, '4fdb63914c3dd.png', 1339777937);
...
(1, 'admin', '管理员', '21232f297a57a5a743894a0e4a801fc3', '', 1339599451, '127.0.0.1', 903, '8888', 'liu21st@gmail.com', '备注信息', 1222907803, 1330263318, 1, 0, ''),
(2, 'demo', '演示', 'fe01ce2a7fbac8fafaed7c982a04e229', '', 1254326091, '127.0.0.1', 90, '8888', '', '', 1239783735, 1254325770, 0, 0, ''),
(3, 'member', '员工', 'aa08769cdcb26674c6706093503ff0a3', '', 1254326104, '127.0.0.1', 15, '', '', '', 1253514375, 1254325728, 1, 0, ''),
(4, 'leader', '领导', 'c444858e0aaeb727da73d2eae62321ad', '', 1254325906, '127.0.0.1', 15, '', '', '领导', 1253514575, 1254325705, 0, 0, '');
