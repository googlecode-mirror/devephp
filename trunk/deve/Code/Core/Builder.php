...
function build_runtime() {
	// 加载常量定义文件
	require DEVE_PATH.'/Code/Core/Defines.php';

	// 定义核心编译的文件
	$runtime[]  =  DEVE_PATH.'/Code/Core/Functions.php'; // 系统函数
	if(version_compare(PHP_VERSION,'5.2.0','<') )
		// 加载兼容函数
		$runtime[] = DEVE_PATH.'/Code/Core/Compat.php';
	// 核心基类必须加载
	$runtime[]  =  DEVE_PATH.'/Code/Core/Deve.class.php';
	// 读取项目核心编译文件列表
	if(is_file(CONFIG_PATH.'/Core.php'))
	    ...
	    // 默认核心
	    $list = include DEVE_PATH.'/Source/Core.php';
