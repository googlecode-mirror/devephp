...
<html>
 ...
 <meta http-equiv="Content-Type" content="text/html; charset=utf-8">
  <title>DevePHP示例：表单提交、自动验证和自动填充</title>
<link rel='stylesheet' type='text/css' href='View/default/common.css'>
 </head>
 <body>
 <div class="main">
 <h2>DevePHP示例之表单处理：自动获取表单数据生成数据对象</h2>
 本示例对提交的表单数据进行处理，自动创建数据对象和进行自动验证和填充。
 <form method='post' action="interface.php?m=Demo&c=Form&a=insert">
 ...
 <tr>
 <td></td>
	<td><hr> 示例源码<br/>控制器DemoForm类<br/><php>highlight_file(CONTROLLER_PATH.'/Demo/DemoForm.class.php');</php><br/>模型FormModel类<br/><php>highlight_file(CONTROLLER_PATH.'/Demo/DemoForm.class.php');</php></td>
 </tr>
 </table>
   </form>
</div>
