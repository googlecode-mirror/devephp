...
{//类定义开始
    ...
    public function __construct()
    {
        ...
        $this->tpl       = Deve::instance('ThinkTemplate');//ThinkTemplate::getInstance();
        $this->_initialize();
        $this->load();
    }
    ...
    public function parseThinkVar($varStr){
        ...
        if(count($vars)>=3){
            ...
            switch($vars[1]){
                ...
                case 'TEMPLATE':$parseStr = 'S("TMPL_FILE_NAME")';break;
                case 'LDELIM':    $parseStr = 'S("TMPL_L_DELIM")';break;
                case 'RDELIM':    $parseStr = 'S("TMPL_R_DELIM")';break;
